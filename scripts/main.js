...
FriendlyChat.prototype.saveMessage = function(e) {
  ...
  if (this.messageInput.value && this.checkSignedInWithMessage()) {
    ...
    this.messagesRef.child(currentUser.uid+dd+'-'+mm+'-'+yyyy+'-'+n).set({
      name: currentUser.displayName,
      topic: this.messageInput.value,
      phone: this.phoneInput.value,
      date: this.dateInput.value,
      audcount: this.audiencecountInput.value,
      mcount: this.mentorcountInput.value,
      ...
      FriendlyChat.resetMaterialTextfield(this.messageInput,
        this.phoneInput,
        this.dateInput,
        this.audiencecountInput,
        this.mentorcountInput);
      this.toggleButton();
