...
FriendlyChat.prototype.loadMessages = function() {
  ...
  var setMessage = function(data) {
    ...
    this.displayMessage(data.key, val.name, val.topic,val.phone,val.date,val.audcount,val.mcount, val.accepted,val.today,val.photoUrl, val.imageUrl);
...
FriendlyChat.resetMaterialTextfield = function(element1,element2,element3,element4,element5,element6,element7) {
  element1.value = '';
...
FriendlyChat.prototype.displayMessage = function(key, name, topic,phone,date,audcount,mcount,accepted,postdate, picUrl, imageUri) {
  ...
  if (topic) { // If the message is text.
    ...
    if(accepted == "Yes")
    { acceptElement.textContent = "Accepted";
