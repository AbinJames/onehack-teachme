...
FriendlyChat.prototype.loadMessages = function() {
  ...
  var setMessage = function(data) {
    ...
    this.displayMessage(data.key, val.name, val.topic,val.phone,val.date,val.audcount,val.mcount, val.accepted,val.studacceptd,val.today,val.photoUrl, val.imageUrl);
...
function showIt(element) {
  ...
  console.log(parent.id);
    ...
    firebase.database().ref('messages').child('gposts').child(parent.id).update({
      ...
      studacceptd:"Yes",
      mentor:firebase.auth().currentUser.displayName
    })
}
...
FriendlyChat.prototype.displayMessage = function(key, name, topic,phone,date,audcount,mcount,accepted,studaccepted,postdate, picUrl, imageUri) {
