...
function FriendlyChat() {
  ...
  this.cnameInput = document.getElementById('cname');
 
  this.phoneInput = document.getElementById('phone');
  
console.log(this.cnameInput+this.phoneInput)
  this.submitButton = document.getElementById('submit');
  this.submitImageButton = document.getElementById('submitImage');
  console.log(this.submitImageButton);
...
FriendlyChat.prototype.loadMessages = function() {
  ...
  var setMessage = function(data) {
    var val = data.val();
   // this.displayMessage(data.key, val.name, val.topic,val.phone,val.date,val.audcount,val.mcount, val.photoUrl, val.imageUrl);
    console.log(val.topic); console.log(this.messagesRef);
  }.bind(this);
...
FriendlyChat.prototype.saveMessage = function(e) {
    ...
    console.log(this.cnameInput.value+this.phoneInput.value)
   firebase.database().ref('messages').child('users').child(currentUser.uid).set({
    ...
    state:"s",
    gradepoint:"0",
    college:this.cnameInput.value,
    phone:this.phoneInput.value
    }).then(function(){
      window.location.href = "sposts.html";
    });
...
FriendlyChat.resetMaterialTextfield = function(element1,element2,element3,element4,element5) {
  element1.value = '';
...
FriendlyChat.prototype.displayMessage = function(key, name, topic,phone,date,audcount,mcount, picUrl, imageUri) {
